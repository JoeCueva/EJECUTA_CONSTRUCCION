                ...
                <div className="electrical-power-systems-specialized-solutions-main-container">
                    ...
                    <div className="electrical-power-systems-solutions-technology-cards-grid">
                        <div className="electrical-power-systems-individual-solution-technology-card">
                            <h3>Sistemas de Distribución Eléctrica</h3>
                            <ul>
                                <li>Subestaciones eléctricas MT/BT desde 100 kVA hasta 3000 kVA con transformadores secos o en aceite</li>
                                <li>Tableros eléctricos certificados según IEC 61439 con barras de cobre y protecciones Schneider, ABB o Siemens</li>
                                <li>Cableado de potencia en bandejas portacables con cables NYY, N2XSY o THHW-LS</li>
                                <li>Mallas de puesta a tierra según IEEE 80 y CNE con mediciones de resistividad</li>
                        ...
                        <div className="electrical-power-systems-individual-solution-technology-card">
                            ...
                            <ul>
                                ...
                                <li>Grupos electrógenos diésel o gas con tableros ATS y sincronización automática</li>
                                <li>Bancos de condensadores automáticos para corrección del factor de potencia</li>
                                <li>Filtros armónicos activos y pasivos cumpliendo IEEE 519 para calidad de onda</li>
                                <li>Reguladores de voltaje y estabilizadores para cargas sensibles</li>
                                <li>Sistemas de monitoreo de calidad de energía con registradores clase A</li>
                            </ul>
                        </div>

                        <div className="electrical-power-systems-individual-solution-technology-card">
                            <h3>Iluminación y Automatización</h3>
                            <ul>
                                <li>Diseño lumínico con DIALux y luminarias LED de alta eficiencia (120 lm/W)</li>
                                <li>Sistemas de control DALI, DMX o KNX para iluminación inteligente corporativa</li>
                                <li>Iluminación de emergencia según NTP 399.010 con respaldo automático</li>
                                <li>Integración con BMS mediante protocolos BACnet, Modbus o LonWorks</li>
                                <li>Medidores de energía multifunción con comunicación IoT para análisis en tiempo real</li>
                                <li>Señalética fotoluminiscente y sistemas de evacuación certificados</li>
                            </ul>
                        </div>
                        ...
                        <div className="electrical-power-systems-individual-solution-technology-card">
                            ...
                            <ul>
                                ...
                                <li>Modernización y retrofitting de tableros obsoletos y sistemas de protección</li>
                                <li>Mantenimiento preventivo según IEC 60364-6 con termografía trimestral</li>
                                <li>Estudios de coordinación de protecciones y selectividad</li>
                                <li>Análisis de aceite dieléctrico y reemplazo predictivo de componentes críticos</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
const Method = () => {
    ...
    const certifications = [
        { code: "ISO 9001", name: "Gestión de Calidad", icon: "fa-solid fa-star" },
        { code: "ISO 14001", name: "Gestión Ambiental", icon: "fa-solid fa-leaf" },
        { code: "ISO 45001", name: "Seguridad y Salud", icon: "fa-solid fa-user-shield" },
        { code: "ISO 37001", name: "Antisoborno", icon: "fa-solid fa-balance-scale" }
    ];

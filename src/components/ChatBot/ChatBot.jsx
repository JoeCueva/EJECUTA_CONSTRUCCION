...
export default function EjecutaChatbot() {
    ...
    const generateAutoResponse = (userMessage) => {
        ...
        if (
            ...
            msg.includes('son confiables') || msg.includes('es confiable') ||
            msg.includes('puedo fiarme') || msg.includes('de fiar') ||
            msg.includes('empresa seria') || msg.includes('empresa formal')
        ) {
